...
$array = [
	...
	'general' => [
		...
		'views_help' => 'Enter the Views here',
...
foreach ($system_languages as $system_language)
{
    foreach ($query as $column)
    {
        ...
        $array['general'][$naming.'_'.$system_language] = $array['general'][$column->COLUMN_NAME].' in '.$system_language.' Language';
    }
}
...
foreach ($system_languages as $system_language)
{
    ...
    {
        $naming =  \Platform\Foundation\Controllers\Controller::cut_string_using_last('_', $column->COLUMN_NAME, 'left', false);
        $array['general']['paragraph_'.$naming.'_'.$system_language] = $array['general']['paragraph_'.$column->COLUMN_NAME].' in '.$system_language.' Language';
    }
}
return $array;
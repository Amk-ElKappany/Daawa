...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'newscategory');

		$('.daterangepicker_end_input').attr('data-grid', 'newscategory');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('newscategory', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);

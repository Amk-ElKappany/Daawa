...
;(function(window, document, $, undefined)
{
	...
	Extension.Index.datePicker = function()
	{
		...
		$('.daterangepicker_start_input').attr('data-grid', 'news');

		$('.daterangepicker_end_input').attr('data-grid', 'news');
	...
	Extension.Index.dataGrid = function()
	{
		...
		Extension.Index.Grid = $.datagrid('news', '#data-grid', '#data-grid_pagination', '#data-grid_applied', config);
